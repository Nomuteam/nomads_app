...
/**
 * Generated class for the CloneeventPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-cloneevent',
  templateUrl: 'cloneevent.html',
})
export class CloneeventPage {
  ...
  public e_type: any = '';
   ...
   constructor( public navCtrl: NavController,
     ...
     public modalCtrl: ModalController) {
      ...
      this.event_data.spaces_available = '0';
      this.event_data.day = '';
